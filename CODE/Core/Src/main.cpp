...
int main(void)
{
  ...
  while (1)
  {
	...
	pulsar::getInstance()->hardwareID();
	pulsar::getInstance()->getFlowVelocity();
	pulsar::getInstance()->serialNumber();
	pulsar::getInstance()->gain();
	HAL_Delay(1000);
  }
  /* USER CODE END 3 */
}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, RS485_PWON_Pin|RS485_RE_Pin|RS485_DE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_MCU_GPIO_Port, LED_MCU_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RS485_PWON_Pin RS485_RE_Pin RS485_DE_Pin */
  GPIO_InitStruct.Pin = RS485_PWON_Pin|RS485_RE_Pin|RS485_DE_Pin;
